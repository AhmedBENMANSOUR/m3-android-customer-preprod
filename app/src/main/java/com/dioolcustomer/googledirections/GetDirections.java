package com.dioolcustomer.googledirections;

import android.os.AsyncTask;
import android.util.Log;

import com.dioolcustomer.callbacks.GoogleDirectionLoadedListener;
...
public class GetDirections {
    ...
    GoogleDirectionLoadedListener listener;

    public GetDirections(GoogleDirectionLoadedListener listener) {
