...
public class WithdrawFundsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.witdrawfundsmenu);
...
//        Analytics.with(this).screen("View", TAG);
        ...
        txtAmount = (EditText) findViewById(R.id.withdraw_funds_amount_edit);
        txtDaBalance = (TextView) findViewById(R.id.textView_da_balance_withdraw);
        txtRevBalance = (TextView) findViewById(R.id.textView_rev_balance_withdraw);
        ...
        cancelButton = (Button) findViewById(R.id.buttonCancel_withdrawFunds);
        mBtnSend = (Button) findViewById(R.id.buttonSend_withdrawFunds);


        mBtnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (MMMUtils.isConnectedTointernet(WithdrawFundsActivity.this)) {

                    final Dialog dialog = new Dialog(WithdrawFundsActivity.this);
                    if (txtAmount.getText().toString().equals("")) {
                        Toast.makeText(WithdrawFundsActivity.this, "Le montant doit être > 0", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (!MMMUtils.isInteger(txtAmount.getText().toString())) {
                        Toast.makeText(WithdrawFundsActivity.this, "Le montant doit être un nombre entier", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        dialog.dismiss();
                        try {
                            startWithdrawFunds(txtAmount.getText().toString());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    Toast.makeText(WithdrawFundsActivity.this, "Veuillez vérifier votre connexion Internet", Toast.LENGTH_SHORT).show();
        ...
        getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Withdraw Funds" + "</font>")));
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // Handle
        switch (item.getItemId()) {
           ...
           /* case R.id.share:
            ...
            case R.id.settings:
                Intent intent = new Intent(WithdrawFundsActivity.this,
    ...
    private void startWithdrawFunds(final String mAmount) throws Exception {

        // Personalize View when loading WS
        final ACProgressFlower dialog = new ACProgressFlower.Builder(new ContextThemeWrapper(WithdrawFundsActivity.this, R.style.myDialog))
        ...
        jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                GlobalConstants.URL_WITHDRAW_FUNDS, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (String.valueOf(mRedeem.getCode()).equals("0")) {
                            SweetAlertDialog mSweet = new SweetAlertDialog(WithdrawFundsActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                    .setTitleText("DIOOL")
                            ...
                            new SweetAlertDialog(WithdrawFundsActivity.this, SweetAlertDialog.WARNING_TYPE)
                                    .setTitleText("DIOOL")
                                    .setContentText(mRedeem.getMessage())
                                    ...
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        ...
                                        public void onClick(SweetAlertDialog sDialog) {
                                            ...
                                            try {
                                                startCofirmWithdrawFunds(mAmount);
                            ...
                            new SweetAlertDialog(WithdrawFundsActivity.this, SweetAlertDialog.ERROR_TYPE)
                                    .setTitleText("DIOOL")
                                    .setContentText(mRedeem.getMessage())
                                    .show();
                        }
    ...
    private void startCofirmWithdrawFunds(String mAmount) throws Exception {
