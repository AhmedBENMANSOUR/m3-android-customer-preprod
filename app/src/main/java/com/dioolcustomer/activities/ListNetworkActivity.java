...
import com.dioolcustomer.fragments.NetworkDetailsFragment;
...
public class ListNetworkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_network);

        ColorDrawable colorDrawable = new ColorDrawable(Color.parseColor("#1a1f3a"));
        getSupportActionBar().setBackgroundDrawable(colorDrawable);
        getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Mon réseau" + "</font>")));

        if (!EventBus.getDefault().isRegistered(this)) {
            EventBus.getDefault().register(this);
        }

        mRecycleView= (RecyclerView) findViewById(R.id.recycler_view_networks);
        ...
        if (MMMUtils.isConnectedTointernet(ListNetworkActivity.this))
            getUserChildrens();
        else {
            Toast.makeText(ListNetworkActivity.this, "Veuillez vérifier votre connexion Internet", Toast.LENGTH_SHORT).show();
    ...
    public void onEvent(OpenNetworkDetails mNetwork) {
        ...
        MMMUtils.addFragment(new NetworkDetailsFragment(),mBundle,NetworkDetailsFragment.class.getCanonicalName(),true,ListNetworkActivity.this,R.id.frame_network);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // Handle
        switch (item.getItemId()) {
            ...
            case R.id.settings:
                Intent intent = new Intent(ListNetworkActivity.this,
    ...
    private void getUserChildrens() {
        ...
        final ACProgressFlower dialog = new ACProgressFlower.Builder(new ContextThemeWrapper(ListNetworkActivity.this, R.style.myDialog))
                    ...
                    public void onResponse(JSONObject response) {
                       ...
                       // Log.e(TAG, response.toString());
                        ...
                        if(mResponse.getMUsers().size()>0) {
                            UserNerworkAdapter mAdapter = new UserNerworkAdapter(mResponse.getMUsers(), ListNetworkActivity.this);
