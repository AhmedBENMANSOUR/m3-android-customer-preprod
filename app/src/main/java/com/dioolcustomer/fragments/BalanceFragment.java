...
import com.dioolcustomer.activities.TransfertSoldeDioolActivity;
import com.dioolcustomer.activities.WithdrawFundsActivity;
...
public class BalanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_balance, container, false);
        ...
        Button mAddFundsButton = (Button) mView.findViewById(R.id.add_funds_button);
        Button mWithdrawFundsButton = (Button) mView.findViewById(R.id.withdraw_funds_button);
        Button m3DioolButton = (Button) mView.findViewById(R.id.transfert_diool_button);
