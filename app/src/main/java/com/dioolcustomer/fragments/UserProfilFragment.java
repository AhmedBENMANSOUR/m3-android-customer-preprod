...
import com.dioolcustomer.activities.UserProfileActivity;
...
public class UserProfilFragment extends Fragment {
    ...
    public static ShopsByOwnerId mShops;
   ...
   /* @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_user_profil, container, false);
       ...
       /* String jsonToken = null;
        ...
        mPhotoUser = (ImageView) mView.findViewById(R.id.image_profile);
        // mTextBusinessName = (TextView) findViewById(R.id.businessname_text);
        mTextEmail = (TextView) mView.findViewById(R.id.email_text);
        mTextFirstName = (TextView) mView.findViewById(R.id.firstname_text);
        mTextLastName = (TextView) mView.findViewById(R.id.lastname_text);
        mTextPhone = (TextView) mView.findViewById(R.id.phone_text);
        mTextNumIdentification = (TextView) mView.findViewById(R.id.num_identification_text);
        mTextTypeIdentification = (TextView) mView.findViewById(R.id.type_identification_text);
        mTextValiditeIdentite = (TextView) mView.findViewById(R.id.validate_identitie_text);
        mTextProfil = (TextView) mView.findViewById(R.id.profil_text);
        mTextCampanyName = (TextView)mView.findViewById(R.id.nom_entreprise_text);
        mTextBusinessRegistration = (TextView)mView.findViewById(R.id.businesregistration_text);
        mTextCity = (TextView)mView.findViewById(R.id.city_text);
        mTextCountry = (TextView)mView.findViewById(R.id.country_text);
        mTextShopName = (TextView)mView.findViewById(R.id.nom_boutique_text);
        ...
        mTextRegistration = (TextView) mView.findViewById(R.id.businesregistration_text);
        mTextTaxCard= (TextView) mView.findViewById(R.id.taxcard_text);
        mTextBusinessAdress = (TextView) mView.findViewById(R.id.adresse_entreprise_text);



        FloatingActionButton fab = (FloatingActionButton) mView.findViewById(R.id.fab_change_shop);
    ...
    private void getshopById() throws Exception {
        ...
        jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(String.valueOf(mShop.getCode()).equals("0")){
                            mTextShopName.setText("Boutique : "+mShop.getName());
                        }else{
                            SweetAlertDialog mSweet =
                                    new SweetAlertDialog(getActivity(), SweetAlertDialog.ERROR_TYPE)
                                            .setTitleText("DIOOL")
                                            .setContentText(mShop.getMessage());
