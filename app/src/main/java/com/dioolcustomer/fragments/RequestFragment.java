...
import com.dioolcustomer.activities.MairchentAirtimeQuoteRequestActivity;
...
public class RequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button mQuoteRequestButton = (Button) mView.findViewById(R.id.quote_request_button);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if(encryption.decrypt(mUserToken.getIdToken(),shared.getString("USER_TYPE_MERCHANT", "")).equals("merchant_airtime") || encryption.decrypt(mUserToken.getIdToken(),shared.getString("USER_TYPE_MERCHANT", "")).equals("customer")){
                        ...
                        Intent intent = new Intent(getActivity(), MairchentAirtimeQuoteRequestActivity.class);
                        startActivity(intent);
                    }else{
                        Intent intent = new Intent(getActivity(), QuoteRequestActivity.class);
                        startActivity(intent);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
